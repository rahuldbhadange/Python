...
class SAPMasterDataIntegrator(IntegratorCallbacks, RetryingThingRunner):
    ...
    def __get_data_for_asset(self, asset_id):
        ...
        if asset_id in ('1000015', '1000020', '1000021'):
            log.warning("Swapping asset_id %s for test id 1000015", asset_id)
            asset_id = '1000015'
    ...
    def __get_aggregate_equipment_num(self, asset_id, usr, pwd, timeout):
        """ returns aggregate_equipment_number for asset_id """
