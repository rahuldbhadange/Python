...
def get_document_by_type(asset_id, document_type):
    ...
    try:
        ...
        #     print("\n-------mime_type-------\n", mime_type)
        #     # print("-------chunk-------\n", chunk)
        #     first_chunk = chunk['Xstring']
        #     print("----first_chunk-------\n", first_chunk)
        #
        #     encoded_data.extend(chunk)
        #
        # json_data = bytes(encoded_data).decode('a2b_base64')    # utf-8
        # decoded_data = json.loads(json_data)
        #
        ...
        #
        # for info in decoded_data:
        #     file_name = info['FileName']
        #     print("-------file_name-------\n",file_name)
        # # for info in encoded_data:
        #     first_chunk = info['Xstring']
        #     print("----first_chunk-------\n", first_chunk)
        ...
        print("\n", file_name, "\n")
        # print("\n", first_chunk, "\n")
        # encoded_data.extend(file_name)
        # json_data = bytes(encoded_data).decode('utf-8')    # utf-8
        # decoded_data = json.loads(json_data)
        # for info in decoded_data:
        #     file_name = info['FileName']
