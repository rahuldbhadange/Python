                                     ...
                                     # I-teration     II-Iteration(exception)       III-Iteration
...
try:                                 #                 (zeroDivisionError)          & not handled)
    ...
    y=int(input("Enter Second No:"))  #100              0                             abc
    z=x/y
    print(z)
...
print("welcome to Hyderabad......")#o/p :Welcome to   o/p: 2nd No cannot          o/p:Abnormal Termination 
                                   #    Hyderabad...    be zero

#but in all the above 3 situations, I want to display "welcome to Hyderabad......",
#then use finally block
                                   
#finally block:The block of stmts which will executed,whether exception occured or not occured or
#exception handled or not handled, but these stms will be executed
...
#so here in all the 3 situations ,keep f.close()(file closing stmt)in finally block so it executes in all 3 situations
